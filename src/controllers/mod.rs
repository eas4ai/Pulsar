...
use suprnova::{
    FormRequest, FrameworkError, HttpResponse, InertiaConfig, InertiaRequestExt, Request,
    ValidationErrors, serde_json,
};
...
pub(crate) fn inertia_config() -> InertiaConfig {
    match suprnova::Environment::detect() {
